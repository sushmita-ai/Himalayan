...
{{--                <div class="menu-item">--}}
{{--                    <a class="menu-link {{ request()->is('admin/subject') || request()->is('admin/subject/*')--}}
{{--                        ? " active" : "" }}" href="{{route('admin.subject.index')}}">--}}
{{--                        <span class="menu-icon">--}}
...
{{--                </div>--}}
{{--                <div class="menu-item">--}}
{{--                    <a class="menu-link {{ request()->is('admin/student') || request()->is('admin/student/*')--}}
{{--                        ? " active" : "" }}" href="{{route('admin.student.index')}}">--}}
{{--                        <span class="menu-icon">--}}
{{--                            <!--begin::Svg Icon | path: icons/duotone/Design/Difference.svg-->--}}
{{--                            <span class="svg-icon svg-icon-2">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"--}}
...
{{--                </div>--}}
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->is('admin/subcategory') || request()->is('admin/subcategory/*')
                        ? " active" : "" }}" href="{{route('admin.subcategory.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/Difference.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->is('admin/package') || request()->is('admin/package/*')
                        ? " active" : "" }}" href="{{route('admin.package.index')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/Difference.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
...
{{--                <div class="menu-item">--}}
{{--                    <a class="menu-link {{ request()->is('admin/employee') || request()->is('admin/employee/*')--}}
{{--                        ? " active" : "" }}" href="{{route('admin.employee.index')}}">--}}
{{--                        <span class="menu-icon">--}}
{{--                            <!--begin::Svg Icon | path: icons/duotone/Design/Difference.svg-->--}}
{{--                            <span class="svg-icon svg-icon-2">--}}
{{--                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"--}}
...
{{--                </div>--}}
{{--                <div class="menu-item">--}}
{{--                    <a class="menu-link {{ request()->is('admin/attendance') || request()->is('admin/attendance/*')--}}
{{--                        ? " active" : "" }}" href="{{route('admin.attendance.index')}}">--}}
{{--                        <span class="menu-icon">--}}
