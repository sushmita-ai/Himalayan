            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                        <!--begin::Menu- wrapper-->
                        <div class="clock-container btn btn-icon btn-active-light-primary position-relative w-200px h-30px w-md-200px bg-light h-md-40px"
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                            ...
                            <img src="{{asset($user->thumbnail_path)}}" alt="metronic" />
                        </div>
                        <!--begin::Menu-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{asset($user->thumbnail_path)}}" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">{{$user->full_name}}
                                            <span
                                                class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{$user->status_text}}</span>
                                        </div>
                                        <a href="#"
